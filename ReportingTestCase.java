...
public class ReportingTestCase{
  ...
  public void verifylogin() 
	...
	@Test(priority=2)	 
	public void checkinactivereport()
	{
		 boolean Userreport1=false;
		 ReportingPage studlist = new ReportingPage(driver);
		 Userreport1 = studlist.inactivereport();
		 driver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS);
		 Assert.assertEquals(Userreport1,true);
